            ...
            <div class="col-md-8 home-companies">
                ...
                <div class="container-fluid p-3 my-3 border">
                    <div class="row">
                        ...
                        <div class="col-md-8">A Engie Brasil Energia, anteriormente Tractebel Energia, é uma das maiores geradoras privadas de energia do Brasil. Com 55 usinas geradoras, a Engie tem capacidade instalada de 8.276 MW. Isso representa cerca de 6% da capacidade do País, com 90% da energia provenientes de fontes renováveis. A companhia também atua nos segmentos de comercialização e transmissão de energia.</div>
                    </div>
                </div>
                <div class="container-fluid p-3 my-3 border">
                    <div class="row">
                        ...
                        <div class="col-md-8">O Grupo Fleury é uma das maiores e mais tradicionais empresas de medicina diagnóstica do País. Realiza anualmente cerca de 70 milhões de exames e análises clínicas e 5 milhões de exames de imagem. Inaugurada em 1926, parte do crescimento da empresa foi por intermédio de aquisições de marcas do setor, como forma de complementar o mix de serviços e expandir a área de cobertura de atendimento.</div>
                    </div>
                </div>
                <div class="container-fluid p-3 my-3 border">
                    <div class="row">
